import { ArrowLeft, Clock, FileText, Hash, User } from "lucide-react";
    ...
    <div>
      ...
      <div className="page-header">
        ...
        <div className="page-actions">
          <button className="hud-button-ghost" onClick={() => onOpenHistory(namespace, recordKey)}>
            History
          </button>
