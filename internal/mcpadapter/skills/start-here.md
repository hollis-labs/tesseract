...
Search across memory + knowledge with `tesseract_lookup` — the unified query surface.
...
- Looking something up? → use `tesseract_lookup` directly; `tesseract_skills recall-and-ranking` for ranking modes.
